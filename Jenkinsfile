  ...
  stages {
    ...
    stage('SAST-Semgrep-Scan') {
        steps {
          ...
          sh 'semgrep --config p/ci --config p/security-audit --config p/secrets --exclude dep/unused-dependency --max-target-bytes 1000000 --severity WARNING --severity ERROR --output scan_results.json --json'
