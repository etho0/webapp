  ...
  stages {
    ...
    stage('SAST-Semgrep-Scan') {
        steps {
          ...
          sh 'semgrep --config p/ci --config p/security-audit --config p/secrets --exclude dep/unused-dependency --max-target-bytes 10000000 --severity WARNING,ERROR --output scan_results.json --json'
